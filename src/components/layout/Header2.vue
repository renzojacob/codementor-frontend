    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <nav class="hidden md:flex items-center space-x-6">
          ...
          <router-link to="/challenges" class="nav-link" active-class="text-orange-600">Challenges</router-link>
      ...
      <div v-if="showMobileMenu" class="md:hidden border-t border-gray-200 py-4 space-y-4">
        ...
        <router-link to="/challenges" class="mobile-link" @click="showMobileMenu = false">Challenges</router-link>
        ...
        <div class="pt-4 border-t border-gray-200 space-y-3">
          ...
          <router-link 
            to="/register" 
            class="block bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center py-2 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200 font-medium"

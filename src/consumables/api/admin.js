...
export const adminAPI = {
  stats: {
    ...
    userGrowth: (months = 6) => 
      axiosInstance.get(`/admin/user-growth?months=${months}`),
    lessonEngagement: (limit = 10) => 
      axiosInstance.get(`/admin/lesson-engagement?limit=${limit}`),
    recentActivity: (limit = 10) => 
      axiosInstance.get(`/admin/recent-activity?limit=${limit}`),
  },

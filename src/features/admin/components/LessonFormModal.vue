        ...
        <form @submit.prevent="$emit('save')" class="space-y-6">
          <div class="grid grid-cols-1 gap-6">
            <div>
              ...
              <input v-model="lesson.title" type="text" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input v-model="lesson.slug" type="text" required
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              ...
              <div>
                ...
                <select v-model="lesson.language_id" required
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div>
              ...
              <textarea v-model="lesson.description" rows="3"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <textarea ref="contentTextarea" v-model="lesson.content" rows="12"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-mono text-sm"
                    placeholder="Write your lesson content using Markdown..."></textarea>
                </div>
                ...
                <div>
                  ...
                  <div class="border border-gray-300 rounded-lg p-4 h-64 overflow-y-auto bg-gray-50">
                    <div v-html="renderMarkdown(lesson.content)" class="prose prose-sm max-w-none">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <input v-model.number="lesson.order_index" type="number" min="0"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Order in the course...">
              <p class="mt-1 text-sm text-gray-500">Determines the display order (lower numbers come first)</p>
            </div>
          </div>
